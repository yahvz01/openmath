...
TEST(test_class_unlimitedint_arithmetic_opt_remainder, test_zero)
{
    EXPECT_THROW(UnLimitedInt result_pos(lhs_obj % 0), std::invalid_argument);
}

TEST(test_class_unlimitedint_arithmetic_opt_remainder, test_int8_t_pos_multiply_two)
{
...
TEST(test_class_unlimitedint_arithmetic_opt_remainder, test_int8_t_pos_multiply_neg_two)
{
    UnLimitedInt result_pos(lhs_obj % -2);
    EXPECT_EQ(result_pos.IsPositive(), true);
    EXPECT_EQ(result_pos.GetBitLength(), 1);
...
TEST(test_class_unlimitedint_arithmetic_opt_remainder, test_int8_t__neg_multiply_two)
{
    int8_t value(0b1111'1101);
    UnLimitedInt value_obj(value);
    UnLimitedInt result_pos(value_obj % 2);
...
TEST(test_class_unlimitedint_arithmetic_opt_remainder, test_int16_t_pos)
{
