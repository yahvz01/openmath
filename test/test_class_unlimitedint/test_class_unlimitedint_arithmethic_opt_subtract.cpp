...
TEST(class_unlimitedint_arithmetic_opt, test_subtract_opt_by_single_byte)
{
...
TEST(class_unlimitedint_arithmetic_opt, test_subtract_opt_by_multi_bytes)
{
...
TEST(class_unlimitedint_arithmetic_opt, test_subtract_obj_by_diff_bytes)
{
    ...
    UnLimitedInt result(result_int);
